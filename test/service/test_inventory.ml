...
let name = "test_inventory."

module Stock_in = struct
  let name = name ^ "stock_in"
  ...
  let suite =
  name>:::
  ["existing item should be updated">:: test_stock_in_existing_item;
   "new item">:: test_stock_in_new_item;
   "invalid item qty">:: test_stock_in_invalid_item_qty;
   "invalid item amt">:: test_stock_in_invalid_item_amt]
